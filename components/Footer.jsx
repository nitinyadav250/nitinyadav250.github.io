...
const Footer = ({className}) => {
    return (
        <div className={className }>
                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="#" target="_blank" className="flex items-center">
                                <span
                                    className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">AttendanceX</span>
			...
			<span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 AttendanceX™. All Rights Reserved.
</span>
